...
//       name: "",
//       role: "",
//       // bio: "", // REMOVED - Backend doesn't accept this field
...
//             {/* BIO FIELD - COMMENTED OUT - May be added back in future backend update */}
//             {/*
//             <div className="grid gap-2">
...
//                 <p className="text-xs text-muted-foreground">
//                   Mark if this member is a team lead
//                 </p>
//               </div>
//               <Switch
//                 checked={!!form.isLeader}
//                 disabled={!editing}
//                 onCheckedChange={(v) => setForm({ ...form, isLeader: v })}
//               />
//             </div> */}
//           </div>
//         </ScrollArea>
