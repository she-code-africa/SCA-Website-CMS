				...
				<div className="w-full mb-12 px-4">
					<div
						...
						<div className="rounded-t mb-0 px-4 py-3 flex justify-between">
							...
							<Link to={paths.allVolunteers}>Back</Link>
						</div>
						<form className="px-4 py-3">
							...
							<div className="text-center my-4 w-6/12 mx-auto">
								<input
									type="submit"
									className="text-center bg-pink-500 py-2 px-4 rounded cursor-pointer text-white text-sm font-semibold block w-full uppercase"
									value="Add Volunteer"
								/>
							</div>
						</form>
