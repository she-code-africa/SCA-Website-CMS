...
import type { SAGActivity, SAGActivitiesFilters } from "@/features/stem-a-girl/activities/types";
...
export default function ActivitiesPage() {
  const [filters, setFilters] = React.useState<SAGActivitiesFilters>({ search: "" });
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="grid gap-3 md:hidden">
            {query.isLoading ? (
              Array.from({ length: 6 }).map((_, i) => <MobileActivitySkeletonCard key={i} />)
            ) : query.isError ? (
